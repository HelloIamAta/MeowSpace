...
import com.example.meowspace.adapter.PostAdapter
...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
        ...
        postList = arrayListOf(
            ...
            PostResponse(getString(R.string.cats4),"Kucuk Siyah Kedi",getString(R.string.cats4),"ittens love to chase laser pointers."),
    ...
    private fun initObservers() {
        ...
        binding?.apply {
            ...
            postRecyView.apply {
                ...
                postAdapter = PostAdapter(requireContext(),postList,navController)
                adapter = postAdapter
